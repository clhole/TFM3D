function PlotAPEHistogram( serieseval, imgpairlbl, ualg, uparamset, ueval, varargin )
%PLOTMAPEHISTOGRAM visualizes the APE distribution over all datasets
%Input:
...
figure
hold on
title(sprintf('APE distribution over the series of %d datasets',ndatasets))
hist(allAPE,20)
xlabel('APE [%]')
ylabel('Occurrence')
